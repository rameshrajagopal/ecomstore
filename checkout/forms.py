...
class CheckoutForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            self.fields[field].width.attrs['size'] = '30'
    ...
    credit_card_type = 
            forms.CharField(widget=forms.Select(choices=CARD_TYPES))
    ...
    credit_card_cc = forms.CharField()
    ...
    def clean_credit_card_number(self):
        ...
        if not cardLuhnChecksumIsValid(stripped_cc_number)
            raise forms.ValidationError('The credit care you enter is invalid')
